...
const Footer = () => {
  ...
  return location.pathname !== "/signup" &&location.pathname!="/login" ? 
    <div className="pt-20 pb-5 p-4 flex gap-8 justify-around  bg-mine-shaft-950 font-['poppins'] flex-wrap                                                                                                  ">
      <div className="w-1/4 xs-mx:w-1/2 xsm-mx:w-full  sm-mx:w-1/3 flex flex-col gap-4">
        <div className="flex gap-1 items-center text-bright-sun-400">
          <IconAnchor className="h-6 w-6" strokeWidth="2.5" />
        ...
        <div
          className="flex gap-3 text-bright-sun-400 [&>div]:bg-mine-shaft-900
