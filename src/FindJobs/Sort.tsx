    ...
    >
      <Combobox.Target>
        <div
          ...
          className="border border-bright-sun-400 cursor-pointer  xsm-mx:mt-2 xs-mx:py-0 xs-mx:px-1 xs-mx:text-xs flex gap-2 text-sm px-2 py-1 rounded-xl items-center"
        >
          {" "}
          {selectedItem}{" "}
