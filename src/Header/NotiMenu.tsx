import { Menu, Indicator, Switch, Notification, Stack } from '@mantine/core';
import { IconBell, IconUserCircle, IconMessageCircle, IconFileCv, IconMoon, IconSun, IconMoonStars, IconLogout2, IconCheck } from '@tabler/icons-react';
...
<Notification onClick={()=>{navigate(noti.route);
   setOpened(false);
   unread(index);
}} 
